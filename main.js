...
class Main extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('urso_azul','assets/ursofofo_azul.png',{ frameWidth: 277, frameHeight: 357});
        ...
        this.load.image('moeda', 'assets/chico.png');
        ...
        this.load.image('jacaré','assets/C3/jacare_zooreta.png');
        this.load.image('omo','assets/C2/omo.png',{frameWidth: 512, frameHeight: 512});
        this.load.image('botaoQ','assets/botao_Q.png');
        this.load.image('gaiola','assets/gaiola.png');
    }
...
const config = {
    ...
    scene: [Main, Scene00, Scene01, Scene02, Scene03,SceneQuiz,SceneAcerto,SceneErro, SceneGameOver, SceneChangePlayer, SceneHUD, SceneLink]
};
