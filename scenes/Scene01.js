...
class Scene01 extends Phaser.Scene {
    constructor() {
        ...
        this.textos = [
            ...
            "Tudo está escondido atrás do meu sistema super criptografado e protegido por meus servos e enigmas que apenas alguém com muito conhecimento sobre a Unilever poderia solucionar.",
            "Se você quiser tentar passar pelo meu desafio, venha e entre no computador."
        ];
        this.teclaF = null;
        this.indiceTexto = 0;
    ...
    update() {
        if (this.teclado.left.isDown || this.WASD.left.isDown) {
            ...
            if (this.player.body.velocity.y === 0) { // Garante que a animação de parar só aconteça quando não estiver pulando
                this.player.anims.play('andar', false);
            }
        }
